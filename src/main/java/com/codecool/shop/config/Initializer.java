...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("Buddy Pine", 170, "USD", "Buddy Pine, commonly known as Syndrome (and formerly Incrediboy), is the main antagonist of The Incredibles. He is Mr. Incredible's former fan.", villain, pixar));
