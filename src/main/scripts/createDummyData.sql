...
INSERT INTO "public"."products" ("id", "name", "description", "defaultprice", "defaultcurrency", "category_id", "supplier_id") VALUES (DEFAULT, 'Snow White', 'apple bitch', 78688, 6668, 3, 4);
INSERT INTO "public"."products" ("id", "name", "description", "defaultprice", "defaultcurrency", "category_id", "supplier_id") VALUES (DEFAULT, 'Random Bitch', 'bitch', 786, 8768, 2, 6);